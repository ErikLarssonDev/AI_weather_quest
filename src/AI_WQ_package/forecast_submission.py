...
def AI_WQ_create_empty_dataarray_offline(variable,fc_start_date,fc_period,teamname,modelname):
    ''' A function that creates an 'empty' dataarray and supports offline forecast evaluation for the AI Weather Quest. 
    '''
